...
void Plot::MoleculesSolution(Molecule* query, Molecule* variable, double angle,
		...
		double deltaX, double deltaY, double deltaZ, double value, string name) {
	cout << "Pintada " << query->mol_name << " and " <<variable->mol_name<<" en " <<name<<"\n";
	...
	string command = "cat "+ query->name_file+".mol2 "+ name+".mol2 > "+ finalname + ".mol2";
	cout << command <<endl;
