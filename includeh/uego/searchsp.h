...
public:
	...
	virtual SearchSpElement* RandNew2(SearchSpElement* s = NULL) = 0;
	...
	virtual SearchSpElement* RandNew3(SearchSpElement* s = NULL) = 0;
		// random element from the whole space
	virtual SearchSpElement* RandNew( short, SearchSpElement* s=NULL ) = 0;
	virtual SearchSpElement* RandNew2( short, SearchSpElement* s=NULL ) = 0;
	// not all attributes are changed. Depend on aleatory value
	virtual SearchSpElement* RandNew3( short, SearchSpElement* s=NULL ) = 0;
		// random element in area given by center and radius index
	...
	virtual SearchSpElement* BetweenNew2( SearchSpElement*,
						     SearchSpElement* s=NULL ) = 0;
	virtual SearchSpElement* MutateBetweenNew( SearchSpElement*,
							     SearchSpElement* s=NULL ) = 0;
	virtual SearchSpElement* BetweenNew3( SearchSpElement*,
							     SearchSpElement* s=NULL ) = 0;
