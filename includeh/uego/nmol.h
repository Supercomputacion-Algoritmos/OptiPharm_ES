...
public:
	...
	virtual SearchSpElement* RandNew2(SearchSpElement* s = NULL);
	virtual SearchSpElement* generateMutationNew(short, SearchSpElement* s=NULL);
	virtual SearchSpElement* RandNew3(SearchSpElement* s = NULL);
	virtual SearchSpElement* RandNew( short, SearchSpElement* s=NULL );
	virtual SearchSpElement* RandNew2( short, SearchSpElement* s=NULL );
	virtual SearchSpElement* RandNew3( short, SearchSpElement* s=NULL );
